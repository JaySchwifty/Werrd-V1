...
class CustomTVC: UITableViewCell {
  ...
  private var word = CustomLbl(textAlignment: .left, minimumFontScale: 0.9, lineBreakMode: .byWordWrapping, numberOfLines: 1, textColor: .systemCyan, adjustsFontSizeToFitWidth: true)

  private var posLbl = CustomLbl(textAlignment: .left, minimumFontScale: 0.65, lineBreakMode: .byTruncatingTail, numberOfLines: 0, textColor: .systemCyan, adjustsFontSizeToFitWidth: true)

  private var definition = CustomLbl(textAlignment: .left, minimumFontScale: 0.8, lineBreakMode: .byTruncatingTail, numberOfLines: 0, textColor: .systemCyan, adjustsFontSizeToFitWidth: true)
